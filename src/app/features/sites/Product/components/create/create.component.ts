...
export class CreateComponent implements OnInit, OnDestroy {
  ...
  Tabs = [
    ...
    },
    {
      ...
      selectedIcon: '/assets/icons/media-colored.svg',
      isSelected: false,
    },
    {
      ID: 3,
      ...
      selectedIcon: '/assets/icons/price-colored.svg',
      isSelected: false,
    },
    {
      ID: 4,
      ...
      selectedIcon: '/assets/icons/daimantion-colored.svg',
      isSelected: false,
    },
    {
      ID: 5,
      ...
      next: (res) => {
        if (res.isSuccess) {
          ...
          if (res.data.media && res.data.media.length > 0) {
            this.images = res.data.media.map((mediaItem) => ({
              uploaded: true,
              src: `${mediaItem.path}`, 
            }));
          } else {
